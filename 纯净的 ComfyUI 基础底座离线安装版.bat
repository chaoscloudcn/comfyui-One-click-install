...
"%~dp0python\python.exe" -m pip download -d "%OFFLINE_DIR%" torch==2.10.0 torchvision torchaudio --index-url https://download.pytorch.org/whl/cu130 --find-links="%OFFLINE_DIR%"
"%~dp0python\python.exe" -m uv pip install torch==2.10.0 torchvision torchaudio --find-links="%OFFLINE_DIR%" --index-url https://download.pytorch.org/whl/cu130
